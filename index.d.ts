...
export interface MultipleSelectListProps {
  ...
  /**
   * The default options of the multiple select list
   */
  defaultOptions?: Array<{ key: any; value: any }>;
  ...
  /**
   * set text of label that apperas at the top of a list of selected values
   */
